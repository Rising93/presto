...
__webpack_require__(/*! ./spinner.js */ "./resources/js/spinner.js"); // require('../../node_modules/swiper/swiper.esm')
// import Swiper, { Navigation, Pagination } from 'swiper';
// require('../../node_modules/swiper/modules/navigation/navigation');
// require('../../node_modules/swiper/modules/pagination/pagination');
// require('../../node_modules/swiper/modules/thumbs/thumbs');
...
__webpack_require__(/*! ./category-mobile.js */ "./resources/js/category-mobile.js");

/***/ }),

/***/ "./resources/js/category-mobile.js":
/*!*****************************************!*\
  !*** ./resources/js/category-mobile.js ***!
  \*****************************************/
/***/ (() => {

var categoryMobile = document.querySelector('.category-mobile-query');
...
var btnBarDiv = document.querySelectorAll('.btnBar div');
var bgColor = document.querySelector('.bgColor');
btnBar.addEventListener('click', function () {
  btnBarDiv.forEach(function (el) {
...
var mySwiper = new Swiper(".mySwiperCube", {
  effect: "cube",
  cubeEffect: {
    shadow: false,
    slideShadows: false
...
var swiperArticles = new Swiper(".mySwiperArticles", {
  spaceBetween: 20,
  loop: true,
  navigation: {
...
var swipercategory = new Swiper(".mySwiperCategory", {
  slidesPerView: 'auto',
  freeMode: true,
  pagination: {
    el: ".swiper-pagination",
...
var mySwiperPreviews = new Swiper(".mySwiperPreviews", {
  spaceBetween: 20,
  slidesPerView: 4,
  watchSlidesVisibility: true,
  watchSlidesProgress: true,
...
var mySwiperPreview = new Swiper(".mySwiperPreview", {
  spaceBetween: 20,
  navigation: {
    nextEl: ".swiper-button-next",
    prevEl: ".swiper-button-prev"
